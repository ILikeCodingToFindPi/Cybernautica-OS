...
export default function Desktop() {
  ...
  // Debug: Log installed apps when they change
  useEffect(() => {
    console.log('Installed apps updated:', windowManager.installedApps);
  }, [windowManager.installedApps]);
        ...
        {windowManager.installedApps.length > 0 && (
          <div className="absolute top-24 left-32 grid grid-cols-4 gap-4 z-10">
            {windowManager.installedApps.map((app) => (
              ...
              >
                <div className={`w-12 h-12 rounded-xl flex items-center justify-center transition-all group-hover:shadow-lg bg-${app.color}/20`}>
